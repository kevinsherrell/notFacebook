...
render() {
    ...
    return (
        ...
        <form className='createAccountForm' name='createAccountForm' onSubmit={this.onSubmit} t>
            ...
            <input className='newPasswordInput' name='password' type="password" placeholder='New password' value={this.state.password} onChange={this.onChange} />
            <input className='newPasswordInput password2Input' name='password2' type="password" placeholder='Confirm Password' value={this.state.password2} onChange={this.onChange} />
